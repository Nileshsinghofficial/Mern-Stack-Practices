...
function monitor(){
    ...
    setTimeout(() => {
        ...
        console.log(
            'Memory used:',
            usedMemory > 6 ? chalk.redBright(`${usedMemory.toFixed(2)} GB / ${(os.totalmem() / (1024 * 1024 * 1024)).toFixed(2)} GB`) : chalk.greenBright(`${usedMemory.toFixed(2)} GB / ${(os.totalmem() / (1024 * 1024 * 1024)).toFixed(2)} GB`)
        )
